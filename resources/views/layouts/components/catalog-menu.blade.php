                            ...
                            @foreach ($type->categories as $category)
                                <li class="catalog-menu__item">
                                    ...
                                    {{-- <ul
                                        ...
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 1</a></li>
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 2</a></li>
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 3</a></li>
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 4</a></li>
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 5</a></li>
                                        <li class="catalog-menu__item"><span>Производитель:</span></li>
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 6</a></li>
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 7</a></li>
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 8</a></li>
                                        <li class="catalog-menu__item"><a href="#"
                                                class="catalog-menu__link">Пункт 9</a></li>
                                    </ul> --}}
                                </li>
                            @endforeach
                        </ul>
