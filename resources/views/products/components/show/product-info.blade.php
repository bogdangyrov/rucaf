    ...
    <div class="tabs">
        ...
        <div id="how-buy" class="tabs__content tabs-content">
            <div class="tabs-txt">
                ...
                <ul>
                    <li>Направьте запрос на наш официальный адрес: <a href="mailto:ptsvrn@mail.ru">ptsvrn@mail.ru</a>.
                    </li>
        ...
        <div id="pay" class="tabs__content tabs-content">
            <div class="tabs-txt">
                ...
                <p>Оплата производится по <strong>безналичному расчету с НДС</strong>. После обработки вашей заявки
                    через сайт или почту <a href="mailto:ptsvrn@mail.ru">ptsvrn@mail.ru</a>, менеджер выставит счет на
                    оплату.</p>
                <ul>
